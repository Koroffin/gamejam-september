...
export class Room {
  ...
  constructor(point: Vector3, direction: Vector3) {
    ...
    for (let i = 0; i < width; i++) {
      ...
      this.addWall({
        ...
        position: new Vector3(xPos, y, zPos),
      });
      ...
      if (xPos !== xNeg) {
        this.addWall({
          rotation: defaultRotation,
          position: new Vector3(xNeg, y, zPos),
        });
      }
      ...
      if (zPos !== zNeg) {
        this.addWall({
          rotation: defaultRotation,
          position: new Vector3(xPos, y, zNeg),
        });
      }
      if (xPos !== xNeg && zPos !== zNeg) {
        this.addWall({
          rotation: defaultRotation,
          position: new Vector3(xNeg, y, zNeg),
        });
      }
      ...
      if (i % 2 === 0 && i !== width - 1 && i !== 0) {
        this.torchPositions.push({
          rotation: defaultRotation,
          position: new Vector3(xPos, y + 2, zNeg - 0.9),
        });
        if (xPos !== xNeg) {
          this.torchPositions.push({
            rotation: defaultRotation,
            position: new Vector3(xNeg, y + 2, zNeg - 0.9),
          });
        }
      }
      if (i % 2 === 1 && i !== width - 1) {
        this.torchPositions.push({
          ...
          position: new Vector3(xPos, y + 2, zPos - 1.33),
        });
        if (xPos !== xNeg) {
          this.torchPositions.push({
            rotation: new Vector3(
            ...
            position: new Vector3(xNeg, y + 2, zPos - 1.33),
          });
        }
      }
    }
    ...
    for (let i = 0; i < height; i++) {
      ...
      if (i % 2 === 0 && i !== height - 1 && i !== 0) {
        this.torchPositions.push({
          rotation: rotatedRotation,
          position: new Vector3(xNeg - 0.89, y + 2, zNeg),
        });
        if (zPos !== zNeg) {
          this.torchPositions.push({
            rotation: rotatedRotation,
            position: new Vector3(xNeg - 0.89, y + 2, zPos),
          });
        }
      }
      if (i % 2 === 1 && i !== height - 1) {
        this.torchPositions.push({
          rotation: new Vector3(
            defaultRotation.x,
            rotatedRotation.y + Math.PI,
            defaultRotation.z,
          ),
          position: new Vector3(xPos - 1.28, y + 2, zNeg),
        });
        if (zPos !== zNeg) {
          this.torchPositions.push({
            rotation: new Vector3(
            ...
            position: new Vector3(xPos - 1.28, y + 2, zPos),
          });
        }
      }
    }
  ...
  getCenter(point: Vector3, direction: Vector3) {
    ...
    const center = new Vector3(
      point.x + direction.x * width * 2,
      point.y,
      point.z + direction.z * height * 2,
    );
    return center;
  }
    ...
    return [
      {
        ...
        position: new Vector3(center.x, center.y, center.z + height * 2),
      },
      {
        direction: new Vector3(0, 0, -1),
        position: new Vector3(center.x, center.y, center.z - height * 2 + 2),
      },
      {
        direction: new Vector3(1, 0, 0),
        position: new Vector3(center.x + width * 2, center.y, center.z),
      },
      {
        direction: new Vector3(-1, 0, 0),
        position: new Vector3(center.x - width * 2 + 2, center.y, center.z),
      },
    ];
  }
